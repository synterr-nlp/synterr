...
def tokens_avoir_3sg() -> list[AnalyzedToken]:
    ...
    return [
        ...
        AnalyzedToken(
            text="une", lemma="un", pos="DET",
            features={"Definite": "Ind", "Gender": "Fem", "Number": "Sing", "PronType": "Art"},
            idx=3, dep_rel="det", head_idx=4, extra={},
        ),
        AnalyzedToken(
            text="pomme", lemma="pomme", pos="NOUN",
            features={"Gender": "Fem", "Number": "Sing"},
            idx=4, dep_rel="obj", head_idx=2, extra={},
        ),
        AnalyzedToken(
            text=".", lemma=".", pos="PUNCT", features={},
            idx=5, dep_rel="punct", head_idx=2, extra={},
        ),
    ]
...
def tokens_etre_copula() -> list[AnalyzedToken]:
    ...
    return [
        AnalyzedToken(
            text="Marie", lemma="Marie", pos="PROPN",
            features={"Gender": "Fem", "Number": "Sing"},
            idx=0, dep_rel="nsubj", head_idx=2, extra={},
        ),
        AnalyzedToken(
        ...
        AnalyzedToken(
            text="heureuse", lemma="heureux", pos="ADJ",
            features={"Gender": "Fem", "Number": "Sing"},
            idx=2, dep_rel="root", head_idx=None, extra={},
        ),
        AnalyzedToken(
...
def tokens_modal_infinitive() -> list[AnalyzedToken]:
    ...
    return [
        ...
        AnalyzedToken(
            text=".", lemma=".", pos="PUNCT", features={},
            idx=5, dep_rel="punct", head_idx=1, extra={},
        ),
    ]
...
def tokens_participle_que_relative() -> list[AnalyzedToken]:
    ...
    return [
        ...
        AnalyzedToken(
            text="pommes", lemma="pomme", pos="NOUN",
            features={"Gender": "Fem", "Number": "Plur"},
            idx=1, dep_rel="nsubj", head_idx=7, extra={},
        ),
        AnalyzedToken(
            text="qu'", lemma="que", pos="PRON",
            features={"PronType": "Rel"},
            idx=2, dep_rel="obj", head_idx=5, extra={},
        ),
        AnalyzedToken(
            text="il", lemma="lui", pos="PRON",
            features={"Gender": "Masc", "Number": "Sing", "Person": "3", "PronType": "Prs"},
            idx=3, dep_rel="nsubj", head_idx=5, extra={},
        ),
        AnalyzedToken(
            text="a", lemma="avoir", pos="AUX",
            features={"Mood": "Ind", "Number": "Sing", "Person": "3", "Tense": "Pres", "VerbForm": "Fin"},
            idx=4, dep_rel="aux:tense", head_idx=5, extra={},
        ),
        AnalyzedToken(
            text="mangées", lemma="manger", pos="VERB",
            features={"Gender": "Fem", "Number": "Plur", "Tense": "Past", "VerbForm": "Part"},
            idx=5, dep_rel="acl:relcl", head_idx=1, extra={},
        ),
        AnalyzedToken(
            text="étaient", lemma="être", pos="AUX",
            features={"Mood": "Ind", "Number": "Plur", "Person": "3", "Tense": "Imp", "VerbForm": "Fin"},
            idx=6, dep_rel="cop", head_idx=7, extra={},
        ),
        AnalyzedToken(
            text="vertes", lemma="vert", pos="ADJ",
            features={"Gender": "Fem", "Number": "Plur"},
            idx=7, dep_rel="root", head_idx=None, extra={},
        ),
        AnalyzedToken(
            text=".", lemma=".", pos="PUNCT", features={},
            idx=8, dep_rel="punct", head_idx=7, extra={},
        ),
    ]
...
def tokens_elided_l() -> list[AnalyzedToken]:
    ...
    return [
        ...
        AnalyzedToken(
            text="arbre", lemma="arbre", pos="NOUN",
            features={"Gender": "Masc", "Number": "Sing"},
            idx=1, dep_rel="nsubj", head_idx=3, extra={},
        ),
        AnalyzedToken(
            text="est", lemma="être", pos="AUX",
            features={"Mood": "Ind", "Number": "Sing", "Person": "3", "Tense": "Pres", "VerbForm": "Fin"},
            idx=2, dep_rel="cop", head_idx=3, extra={},
        ),
        AnalyzedToken(
            text="grand", lemma="grand", pos="ADJ",
            features={"Gender": "Masc", "Number": "Sing"},
...
def tokens_elided_qu() -> list[AnalyzedToken]:
    ...
    return [
        AnalyzedToken(
            ...
            idx=0, dep_rel="obj", head_idx=2, extra={},
        ),
        AnalyzedToken(
            text="il", lemma="lui", pos="PRON",
            features={"Gender": "Masc", "Number": "Sing", "Person": "3", "PronType": "Prs"},
        ...
        AnalyzedToken(
            text="vienne", lemma="venir", pos="VERB",
            features={"Mood": "Ind", "Number": "Sing", "Person": "3", "Tense": "Pres", "VerbForm": "Fin"},
            idx=2, dep_rel="root", head_idx=None, extra={},
        ),
        AnalyzedToken(
            text="bientôt", lemma="bientôt", pos="ADV", features={},
            idx=3, dep_rel="advmod", head_idx=2, extra={},
        ),
        AnalyzedToken(
            text="!", lemma="!", pos="PUNCT", features={},
            idx=4, dep_rel="punct", head_idx=2, extra={},
        ),
    ]
...
def tokens_au_contraction() -> list[AnalyzedToken]:
    ...
    return [
        ...
        AnalyzedToken(
            text="va", lemma="aller", pos="VERB",
            features={"Mood": "Ind", "Number": "Sing", "Person": "3", "Tense": "Pres", "VerbForm": "Fin"},
            idx=1, dep_rel="root", head_idx=None, extra={},
        ),
        AnalyzedToken(
            text="à", lemma="à", pos="ADP", features={},
            idx=2, dep_rel="case", head_idx=4, extra={},
        ),
        AnalyzedToken(
        ...
        AnalyzedToken(
            ...
            features={"Gender": "Masc", "Number": "Sing"},
            idx=4, dep_rel="obl:arg", head_idx=1, extra={},
        ),
        AnalyzedToken(
            text=".", lemma=".", pos="PUNCT", features={},
            idx=5, dep_rel="punct", head_idx=1, extra={},
...
def tokens_du_contraction() -> list[AnalyzedToken]:
    ...
    return [
        ...
        AnalyzedToken(
            text="vient", lemma="venir", pos="VERB",
            features={"Mood": "Ind", "Number": "Sing", "Person": "3", "Tense": "Pres", "VerbForm": "Fin"},
            idx=1, dep_rel="root", head_idx=None, extra={},
        ),
        AnalyzedToken(
            text="de", lemma="de", pos="ADP", features={},
            idx=2, dep_rel="case", head_idx=4, extra={},
        ),
        AnalyzedToken(
            text="le", lemma="le", pos="DET",
        ...
        AnalyzedToken(
            text="village", lemma="village", pos="NOUN",
            features={"Gender": "Masc", "Number": "Sing"},
            idx=4, dep_rel="obl:arg", head_idx=1, extra={},
        ),
        AnalyzedToken(
...
def tokens_t_il_inversion() -> list[AnalyzedToken]:
    ...
    return [
        ...
        AnalyzedToken(
            text="chocolat", lemma="chocolat", pos="NOUN",
            features={"Gender": "Masc", "Number": "Sing"},
            idx=4, dep_rel="obj", head_idx=0, extra={},
        ),
        AnalyzedToken(
            text="?", lemma="?", pos="PUNCT", features={},
            idx=5, dep_rel="punct", head_idx=0, extra={},
        ),
    ]
...
def tokens_fronted_advcl() -> list[AnalyzedToken]:
    ...
    return [
        AnalyzedToken(
            text="Quand", lemma="quand", pos="SCONJ", features={},
            idx=0, dep_rel="mark", head_idx=2, extra={},
        ),
        AnalyzedToken(
            text="il", lemma="lui", pos="PRON",
            features={"Gender": "Masc", "Number": "Sing", "Person": "3", "PronType": "Prs"},
        ...
        AnalyzedToken(
            text="pleut", lemma="pleuvoir", pos="VERB",
            features={"Mood": "Ind", "Number": "Sing", "Person": "3", "Tense": "Pres", "VerbForm": "Fin"},
            idx=2, dep_rel="advcl", head_idx=5, extra={},
        ),
        AnalyzedToken(
            text=",", lemma=",", pos="PUNCT", features={},
            idx=3, dep_rel="punct", head_idx=2, extra={},
        ...
        AnalyzedToken(
            ...
            idx=4, dep_rel="nsubj", head_idx=5, extra={},
        ),
        AnalyzedToken(
            text="reste", lemma="rester", pos="VERB",
            features={"Mood": "Ind", "Number": "Sing", "Person": "1", "Tense": "Pres", "VerbForm": "Fin"},
            idx=5, dep_rel="root", head_idx=None, extra={},
        ),
        AnalyzedToken(
            text="à", lemma="à", pos="ADP", features={},
            idx=6, dep_rel="case", head_idx=8, extra={},
        ),
        AnalyzedToken(
            text="la", lemma="le", pos="DET",
            features={"Definite": "Def", "Gender": "Fem", "Number": "Sing", "PronType": "Art"},
            idx=7, dep_rel="det", head_idx=8, extra={},
        ),
        AnalyzedToken(
            text="maison", lemma="maison", pos="NOUN",
            features={"Gender": "Fem", "Number": "Sing"},
            idx=8, dep_rel="obl:arg", head_idx=5, extra={},
        ),
        AnalyzedToken(
            text=".", lemma=".", pos="PUNCT", features={},
            idx=9, dep_rel="punct", head_idx=5, extra={},
        ),
    ]
