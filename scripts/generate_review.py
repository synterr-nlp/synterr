...
ALL_HANDLERS = [
    ...
    "pronoun_n_form", "verb_iterative_suffix",
    "agr_sv_collective", "agr_sv_counting", "agr_sv_compound", "agr_sv_coordinated",
    "agr_mn_apposition", "agr_mn_compound_term", "agr_mn_numeral_adj",
