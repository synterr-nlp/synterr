...
# Ландшафт: подходы к синтетическим ошибкам
...
# RuBLiMP: дополняет, не конкурирует
...
# LORuGEC: конкретные правила vs категории
...
# LORuGEC: что synterr МОЖЕТ и НЕ МОЖЕТ
