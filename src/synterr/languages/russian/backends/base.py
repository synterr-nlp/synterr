"""Base protocol for Russian analyzer backends."""
...
class AnalyzerBackend(Protocol):
    """Protocol for Russian NLP analyzer backends.

    All backends must implement this interface to be used
    with the Russian language module.
    """

    @property
    def name(self) -> str:
        """Backend name (e.g., 'stanza', 'natasha', 'spacy')."""
        ...
